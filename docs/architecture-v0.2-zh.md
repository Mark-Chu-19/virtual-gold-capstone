...
| 版本 | 日期 | 狀態 | 團隊 | 客戶窗口 |
|---|---|---|---|---|
| v0.2 團隊合併版 | 2026-09-08 | 團隊討論中 | CMU MISM · 5 人 | Urte Jesina |
...
- **本地推論:**Llama 3.1 8B 為主力,Qwen3 8B 為程式與多語言題目的備選;透過 Ollama 在團隊筆電上跑。
...
| 硬體與模型大小 | 8B 級模型 4-bit 量化,約 6GB 記憶體,在團隊筆電上跑。 | 五台筆電可行的上限。 | 提供 GPU 則可測 14B 級。 |
...
- [ ] **本地模型與硬體。**Llama 3.1 8B 主力、Qwen3 8B 備選。確認五台筆電的記憶體與 GPU,決定量化位元。
...
*Hybrid AI Assistant 架構草案 v0.2 團隊合併版 · Capstone for Virtual Gold Inc · 2026-09-08*

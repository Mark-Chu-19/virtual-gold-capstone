...
| 5 | **本地模型與硬體** | Llama 3.1 8B 主力、Qwen3 8B 備選。確認五台筆電的記憶體與 GPU,決定量化位元。 | | | [ ] |
...
| # | 修正 | 完成 |
|---|---|---|
| 14 | 「Llama 3.3 8B」改為 Llama 3.1 8B(Llama 3.3 只有 70B) | [ ] |
| 15 | 「Qwen3 7B」改為 Qwen3 8B(7B 是 Qwen2.5) | [ ] |
| 16 | 圖:「高信心直接回覆」的箭頭不應經過 PII 遮罩閘道 | [ ] |
| 17 | 模型數據改引 Meta 與 Qwen 官方 model card,框架改引 NIST AI RMF 原文,不引部落格 | [ ] |
| 18 | 時程對齊課程:W7 期中、W8 秋假、W14 感恩節 | [ ] |
...
|---|---|---|---|
| 19 | 確認或修改第十節的八項預設方案 | | |
| 20 | 提案中提到的「企業與小企業資料」有沒有範例文件或格式 | | |
| 21 | 國際開源模型(Qwen3)可否納入評估 | | |

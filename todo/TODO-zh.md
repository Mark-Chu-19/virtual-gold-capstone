...
| # | 修改 | 完成 |
|---|---|---|
| 24 | 第 6 節假設第 3 條:「開發與實驗主要在學生筆電、桌機或其他核准的沙盒環境進行」改為「開發與實驗主要在客戶或 CMU Computing Services 提供的雲端沙盒環境進行,該環境設定為模擬企業地端部署;學生筆電只用於開發」。 | [x] |
| 25 | 第 6 節新增依賴:「客戶將提供雲端沙盒環境供測試使用,如 2026 年 9 月 3 日會議所討論」。 | [x] |
| 26 | 第 6 節費用歸屬:v2 已寫入紅字段落,金額留 $[X] 佔位;B15 有答案後填入金額並刪掉「待客戶確認」字樣。 | [ ] |

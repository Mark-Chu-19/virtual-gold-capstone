...
| 2026-09-14 | 信心評分 MVP 排除口頭表態信心;訊號優先順序為 token 機率信心與 Semantic Entropy Probe,優先於自我一致性/完整語意熵 | 2026 年一項針對七個 3B–9B 開源模型的篩檢發現口頭表態信心會收斂(91.7% 的回覆自報信心 ≥95%,與答對答錯無關);見 `docs/confidence-harness-design-zh.md` 與 `reference/team/confidence_scoring_harness_report_concise_en.md` |
